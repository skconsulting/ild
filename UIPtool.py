...
#ex61 16 global cont int, No local contr, no cmean, full depth,  back-ground,only ge+gre, 13 bits cross
#ex66 16 global cont int, No local contr, no cmean, full depth,  back-ground,ge+gre,overlap roi , 13 bits cross
...
thrpatch = 0.8             # threshold for patch acceptance in area ratio
