# coding: utf-8
#sylvain Kritter 25 september 2016
import os
from scipy import misc
import numpy as np

#data set creation, 6 enhavcement, with Back-ground, 
#equualisation for back_ground only
...
# input patches files
patch_dir=os.path.join(dirHUG,'patches_norm_20n')
#output pickle dir
pickle_dir=os.path.join(cwdtop,'pickle_ds14')
...
for f in usedclassif:
    print (f,classNumberInit[f],classNumberInit[f]/6)
