...
from modulescore2 import visuarun,lisdirprocess,predictmodule
from param_pix_s2 import source
...
#                print 'paramdict source exist',paramdict
                pickle.dump(paramdict,open( paramsaveDirf, "wb" ))
                if pbg==False:
                    pbg=True
                break
            else:
#               print 'paramdict source does not exist exist',sourced
