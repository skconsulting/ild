...
def genedct(f,fea,lab):
    ...
    for i in range (0,l):                                        
        ...
        labi=lab[i]
        image=fea[i]
        imagedct=dct(image, 2,norm='ortho')
...
for f in usedclassifFinal:
    features_train_final=features_train_final+features_aug_dct_train[f]
    features_test_final=features_test_final+features_dct_test[f]
    labels_train_final=labels_train_final+labels_aug_dct_train[f]
    labels_test_final=labels_test_final+labels_dct_test[f]
